package ai.jgp.drsti.spark.demo.airtraffic.lab320_yearly_air_traffic;
 ...
 *
 */
public class YearlyAirTrafficApp {
  private static Logger log =
      LoggerFactory.getLogger(YearlyAirTrafficApp.class);

  public static void main(String[] args) {
    YearlyAirTrafficApp app = new YearlyAirTrafficApp();
    app.start();
  }
